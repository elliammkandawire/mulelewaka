...
<head>
	...
	<link rel="stylesheet" href='../../../../../css.css?family=Open+Sans:400,700'>
	<!--[if lt IE 9]>
...
<nav class="navbar sticker wrapper100percent">
	<a class="navbar-brand" href="<?php echo base_url() ?>">
		<img src="<?php echo  base_url()?>images/logo.png" alt="" style="object-fit: cover; max-height: 60px;">
	</a>
	...
	<div class="collapse navbar-collapse navbar-ex1-collapse">
		<div class="cl-effect-12">
			<ul class="nav navbar-nav pull-right">
				...
				<li><a href="<?php echo base_url(); ?>children-corner">Children Corners</a></li>
				<li><a href="<?php echo  base_url();?>activism">Activism</a></li>
