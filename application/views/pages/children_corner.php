						...
						<article class="col-sm-6 col-xs-12 masonryselector">
							<div class="row">
								<div class="col-sm-12 marginbottom2">
									<div class="item">
										<img src="<?php echo  base_url()?>images/children_corner/<?php echo $activism->picture_url ?>" alt="picture">
										<div class="owl-theme-inner">
											...
											<div class="owl-theme-inner-text">
												...
												<a href="<?php echo base_url() ?>children_corner/<?php echo $activism->slug ?>" class="btn btn-2 btn-2b"><span>more</span></a>
											</div>
										</div>
									</div>
								</div>
