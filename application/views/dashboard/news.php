...
<div class="col-lg-9"><!--start col-lg-4-->
	...
	<div class="w3-card-16">
		<header class="w3-container w3-blue">
			<h5>News</h5>
			<button class="btn btn-success" data-toggle="modal" data-target="#add_client" onclick="addNote()" data-whatever="@mdo"><i class="fa fa-plus"></i> Add</button>
		</header>
		<div id="container" class="row" style="width: 100%;">
			<?php foreach($data as $article): ?>
				<div class="gallery w3-container col-lg-3">
					<a target="_blank">
						<img src="<?php echo base_url(); ?>images\news\<?php echo $article->picture_url; ?>" alt="" style="object-fit: cover; height: 200px;" >
					</a>
					<div class="desc"><?php echo $article->title;  ?></div>
					<div class="container">
						<button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#edit_client" data-whatever="@mdo" onclick="edit_news('<?php echo $article->slug; ?>')"><i class="fa fa-edit"></i></button>
						<button class="btn btn-warning btn-sm" onclick="deleteItem('<?php echo $article->slug; ?>','<?php echo $article->title; ?>','delete_news')"><i class="fa fa-trash"></i></button>
					</div>
				</div>
			<?php endforeach; ?>
		</div>
			...
			<nav aria-label="Page navigation">
				<ul class="pagination">
					<?php foreach($pagenation as $page_number): ?>
						<li class="page-item <?php if($page==$page_number){ echo "active";} ?>"><a class="page-link active" href="<?php echo base_url() ?>news_admin/<?php echo $page_number ?>"><?php echo $page_number ?></a></li>
					<?php endforeach; ?>
				</ul>
			</nav>
		</div>
	...
	<div class="modal-dialog" role="document" style="width: 60%">
		<div class="modal-content">
			...
			<div class="modal-body">
				<?php echo form_open_multipart('add_news');?>
				<div class="row">
					<div class="col-lg-6">
					...
					<div class="col-lg-6">
						<div class="form-group">
							...
							<input type="file" class="form-control" name="picture" accept=".jpg, .png, .jpeg, .gif"  onchange="readURL(this,'picture')" required>
						</div>
