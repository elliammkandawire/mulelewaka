					...
					<div id="container" class="row" style="width: 100%;">
						   <?php foreach($data as $activism): ?>
							<div class="gallery w3-container col-lg-3">
							  <a target="_blank">
							    <img src="<?php echo base_url(); ?>images\activism\<?php echo $activism->picture_url; ?>" alt="" style="object-fit: cover; height: 200px;" >
							  </a>
							  <div class="desc"><?php echo $activism->title;  ?></div>
							  <div class="container">
							  	 <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#edit_client" data-whatever="@mdo" onclick="edit_activism('<?php echo $activism->slug; ?>')"><i class="fa fa-edit"></i></button>
							  	 <button class="btn btn-warning btn-sm" onclick="delete_activism('<?php echo $activism->slug; ?>','<?php echo $activism->title; ?>')"><i class="fa fa-trash"></i></button>
							  </div>
							 </div>
							<?php endforeach; ?>
					</div>
						 ...
						 <nav aria-label="Page navigation">
							 <ul class="pagination">
								 <?php foreach($pagenation as $page_number): ?>
									 <li class="page-item <?php if($page==$page_number){ echo "active";} ?>"><a class="page-link active" href="<?php echo base_url() ?>activism_admin/<?php echo $page_number ?>"><?php echo $page_number ?></a></li>
								 <?php endforeach; ?>
							 </ul>
						 </nav>
	                </div>
  ...
  <div class="modal-dialog" role="document" style="width: 60%">
    <div class="modal-content">
      ...
      <div class="modal-body">
		  <?php echo form_open_multipart('add_activism');?>
      	<div class="row">
      		<div class="col-lg-6">
      		...
      		<div class="col-lg-6">
		            ...
		            <input type="file" class="form-control" name="picture_url" accept=".jpg, .png, .jpeg, .gif"  onchange="readURL(this,'logo_image')">
		          </div>

		           <div>
		            	<img src="#" alt="" style="object-fit: cover; height: 200px; width: 50%;" id="logo_image">
		            </div>
		            <br>
      		</div>
      	</div>
  ...
  <div class="modal-dialog" role="document" style="width: 50%;">
    <div class="modal-content">
      ...
      <div class="modal-body">
		  ...
		  <?php echo form_open_multipart('update_activism');?>
        <div class="row">
        	 <div class="col-lg-6">
